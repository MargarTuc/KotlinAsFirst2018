...
fun russian(n: Int): String {
    val hundreds = listOf<String>("", "сто ", "двести ", "триста ", "четыреста ", "пятьсот ", "шестьсот ", "семьсот ",
            "восемьсот ", "девятьсот ")
    val tens = listOf<String>("десять ", "одиннадцать ", "двенадцать ", "тринадцать ", "четырнадцать ", "пятнадцать ",
    ...
    fun strBuild(num: Int, check: Boolean): String {
        ...
        n2 %= 100
        builder.append(if (n2 / 10 == 1) tens[n2 % 10]
        else tenss[n2 / 10])
